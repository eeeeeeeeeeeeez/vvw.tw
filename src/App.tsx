    ...
    {[
      ...
      <section key={section.id} className={`grid grid-cols-1 lg:grid-cols-12 gap-0 relative group ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
        <div className={`lg:col-span-4 flex flex-col justify-start ${idx % 2 !== 0 ? 'lg:order-2 lg:items-end text-right' : ''}`}>
          ...
          <h2 className="text-[clamp(2.5rem,8vw,3rem)] font-black text-primary uppercase leading-none -mt-8 relative z-10">{section.title}</h2>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 text-primary/40 hover:text-primary transition-colors z-20"
                >
