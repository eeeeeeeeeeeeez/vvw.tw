        ...
        <AnimatePresence>
          {activeTab === "home" && (
            <motion.button
              ...
              className="flex items-center justify-center bg-primary text-white rounded-full shadow-xl shadow-primary/30 hover:bg-secondary transition-colors active:scale-95 w-14 h-14 md:w-16 md:h-16"
              aria-label="開啟亨波AI"
            >
              <i className="fa-solid fa-disease text-xl md:text-2xl" aria-hidden="true"></i>
            </motion.button>
          )}
        </AnimatePresence>
      </div>
