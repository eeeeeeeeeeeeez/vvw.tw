...
export const Home: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Hero */}
      <section className="relative px-6 md:px-8 py-12 md:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-12 gap-0 relative">
          <div className="absolute -right-20 top-0 opacity-5 pointer-events-none select-none hidden md:block">
          ...
          <div className="col-span-12 lg:col-span-6 lg:col-start-3 bg-primary p-8 md:p-12 relative z-20 border-r-8 border-secondary">
      ...
      {/* Why Choose Us */}
      <section className="px-6 md:px-8 py-16 md:py-32 bg-white">
      ...
      {/* Bento Grid */}
      <section className="px-6 md:px-8 py-16 md:py-32 bg-surface-low border-t-2 border-primary">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-8 group bg-white brutalist-border p-6 md:p-12 hover:bg-primary hover:text-white snap-transition relative overflow-hidden">
            ...
            <div className="col-span-12 md:col-span-4 bg-secondary p-6 md:p-12 text-white brutalist-border border-secondary relative">
              ...
              <button onClick={() => navigate("/services")} className="bg-white text-primary px-6 py-3 font-black uppercase tracking-widest hover:bg-primary hover:text-white snap-transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary">了解更多</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="px-6 md:px-8 py-20 md:py-40 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <input 
              ...
              placeholder="您的電子郵件" 
              className="flex-grow bg-surface-low border-4 border-primary p-6 font-black text-xl focus:outline-none focus:bg-white focus-visible:ring-4 focus-visible:ring-secondary snap-transition"
            />
            <button 
              onClick={handleSubscribe}
              disabled={ctaLoading}
              className="whitespace-nowrap bg-primary text-white px-8 md:px-12 py-6 font-black text-xl uppercase tracking-widest hover:bg-secondary snap-transition disabled:opacity-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-secondary"
            >
              {ctaLoading ? "處理中..." : "立即訂閱"}
            </button>
          </div>
